...
import { Search, Filter, ChevronRight, Package, Clock, CheckCircle2, Truck, XCircle } from 'lucide-react';
            ...
            {filteredOrders.length > 0 ? (
              filteredOrders.map((order) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-gray-500">{format(order.createdAt, 'MMM dd, yyyy')}</td>
                  ...
                  <td className="px-6 py-4">
                    <span className={cn(
                      ...
                      order.paymentStatus === 'pending' ? "bg-orange-50 text-orange-700" :

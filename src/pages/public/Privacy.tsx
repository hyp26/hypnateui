  ...
  return (
    <div className="bg-white py-20 px-6">
      <div className="max-w-3xl mx-auto prose prose-lg prose-primary">
        ...
        <p>Hypnate can integrate with third-party platforms such as Meta/WhatsApp and payment providers such as Razorpay. When you connect a third-party service, information may be exchanged as necessary to provide the integration. Those providers may process information under their own terms and privacy policies.</p>

        <h3>5. Merchant Customer Data</h3>
